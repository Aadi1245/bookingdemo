...
import 'package:demoappfortest/screens/seat_selection_screen/bus_seat_selection.dart';
import 'package:demoappfortest/screens/seat_selection_screen/enhanced_seat.dart';
...
class _SeatSelectionScreenState extends State<SeatSelectionScreen>
  ...
  getseatList() {
    var response = AppConst.seatLayoutDataModel;
    ...
    List<SeatModell> seatModelList = seatInfoList
        .where((seat) => seat.seatNo != '-') // Exclude unwanted seats
        .map((seat) {
      return SeatModell(
        seatNo: seat.seatNo ?? '',
        fare: (seat.fare ?? 0).toDouble(),
...
// ✅ Print to verify
  ...
  //   var headers = {
  //     'token':
  //         'MTIxYzMyYzExNWMxMTNjOTljMTEyYzEwOGM5NWMxMDdjOTljMzJjNTZjMzJjOTVjMTEwYzEwM2M5NWMxMDFjOTljMTA4YzExNGMzMmM0MmMzMmMxMTBjOTVjMTEzYzExM2MxMTdjMTA5YzExMmM5OGMzMmM1NmMzMmM0N2M0OGM0OWMzMmMxMjNjNjQ',
  //     'Content-Type': 'application/json',
  //     'Cookie': 'PHPSESSID=1imi8gbpivti8qpnv52sk7t7de'
  //   };
  ...
  //     'https://ops.vaagaibus.com/api/GetSeatLayout/apiagent',
  //     options: Options(
  //       method: 'POST',
  //       headers: headers,
  //     ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: _buildSeatSelection()

        //  BlocProvider(
        //   create: (context) => SeatLayoutBloc(widget.trip),
          ...
          builder: (BuildContext context, ScrollController scrollController) {
            return EnhancedBusInfoBottomSheet(
              ...
              busInfo: BusInfo(
                ...
                time:
                    "${DateFormat('hh:mm a').format(DateTime.parse(widget.trip!.deptime.toString()))} --> ${DateFormat('hh:mm a').format(DateTime.parse(widget.trip!.arrtime.toString()))}" ??
                        "10:00 AM",
              ),
