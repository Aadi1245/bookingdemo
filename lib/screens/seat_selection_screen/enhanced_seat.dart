...
import 'dart:ui';
import 'package:demoappfortest/bloc/booking_bloc/booking_bloc.dart';
...
import 'package:demoappfortest/utils/toast_messages.dart';
...
class _EnhancedBusInfoBottomSheetState
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => BookingBloc(widget.tripData!),
