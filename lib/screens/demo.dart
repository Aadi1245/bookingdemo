...
import 'package:demoappfortest/widgets/boarding_droping_selector.dart';
...
class _DemoState extends State<Demo> {
  final List<Map<String, dynamic>> onboardingPoints = [
    {'name': 'Pandharpur Central', 'time': '18:45', 'selected': false},
    {'name': 'Velapur Junction', 'time': '19:20', 'selected': false},
    {'name': 'Malapras Station', 'time': '19:55', 'selected': false},
    {'name': 'Nateshwar Hub', 'time': '20:15', 'selected': false},
    {'name': 'Swargate Terminal', 'time': '21:00', 'selected': false},
    {'name': 'Pune East Gate', 'time': '21:30', 'selected': false},
    {'name': 'Shirdi Bypass', 'time': '22:10', 'selected': false},
  ];

  final List<Map<String, dynamic>> droppingPoints = [
    {'name': 'Swargate Terminal', 'time': '21:00', 'selected': false},
    {'name': 'Jejuri Outpost', 'time': '21:40', 'selected': false},
    {'name': 'Vallabh Nagar Stop', 'time': '22:15', 'selected': false},
    {'name': 'Chinchwad Depot', 'time': '22:45', 'selected': false},
    {'name': 'Nigadi Plaza', 'time': '23:10', 'selected': false},
    {'name': 'Lonavala Rest', 'time': '23:50', 'selected': false},
    {'name': 'Khopoli Exit', 'time': '00:30', 'selected': false},
    {'name': 'Panvel Station', 'time': '01:00', 'selected': false},
    {'name': 'Kamtothe Halt', 'time': '01:20', 'selected': false},
    {'name': 'Kokan Bhavan', 'time': '01:45', 'selected': false},
    {'name': 'Neru End Point', 'time': '02:00', 'selected': false},
  ];
  final passengers = [
